...
const char HTTP_HEAD[] PROGMEM            = "<!DOCTYPE html><html lang=\"en\"><head>\
                                            ...
                                            <title>{v}</title>";
const char HTTP_STYLE[] PROGMEM           = "<style>.c{text-align: center;} div,input{padding:5px;font-size:1em;} input{width:95%;}\
...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>Configure WiFi</button></form><br/>\
                                            ...
                                            <form action=\"/update\" method=\"get\"><button>Update Firmware</button></form>";
...
class WiFiManager
{
  ...
  private:
    ...
    std::unique_ptr<ESP8266HTTPUpdateServer> httpUpdater;
